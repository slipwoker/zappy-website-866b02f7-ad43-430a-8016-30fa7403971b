...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (phoneHeaderBtn) {
    phoneHeaderBtn.addEventListener('click', function() {
      const phoneNumber = '+972528750091';
        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '866b02f7-ad43-430a-8016-30fa7403971b',
                name: formData.name,
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "יעל מימון – אימון בקבוצות קטנות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
